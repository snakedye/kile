...
pub fn dwindle(mut window_tree:Vec<basic::Frame>, output:basic::Frame, client_count:u32, master_count:u32, master_factor:f32) -> Vec<basic::Frame> {
    ...
    if client_count==1 {
        ...
        window_tree=basic::vertical(window_tree, master_count, 0, master_factor, main_frame[0]);
        window_tree=basic::dwindle(window_tree, client_count-master_count, main_frame[1]);
    }
...
pub fn centered_master(mut window_tree:Vec<basic::Frame>, output:basic::Frame, client_count:u32, master_count:u32, master_factor:f32) -> Vec<basic::Frame> {
    ...
    if client_count==1 {
        ...
        window_tree=basic::dwindle(window_tree, client_count-master_count-((client_count-master_count)/2), main_frame[2]);
    };
...
pub fn nested(mut window_tree:Vec<basic::Frame>, output:basic::Frame, client_count:u32, master_count:u32, master_factor:f32) -> Vec<basic::Frame> {
    ...
    if client_count==1 {
        ...
        let main_frame:Vec<basic::Frame>=basic::dwindle(main_tree, 3, output);
        window_tree=basic::tab(window_tree, master_count, main_frame[0]);
        window_tree=basic::horizontal(window_tree, (client_count-master_count)/2, 0, master_factor, main_frame[1]);
